...
public class DiamondDrillRecipeCategory implements RecipeCategory {
    ...
    public void drawExtras(Minecraft minecraft) {
        ItemRenderUtil.drawScaledItem(minecraft, new ItemStack(BlockListener.diamondDrill), 64, 28, 2);
        ItemRenderUtil.drawScaledItem(minecraft, new ItemStack(net.kozibrodka.wolves.events.BlockListener.gearBox), 64, 70, 1);
        ItemRenderUtil.drawScaledItem(minecraft, new ItemStack(net.kozibrodka.wolves.events.BlockListener.axleBlock), 80, 70, 1);
