...
public class InfusionShapedRecipeWrapper implements RecipeWrapper {
    private final MysticalInfuserShapedRecipe recipe;

    public InfusionShapedRecipeWrapper(MysticalInfuserShapedRecipe recipe) {
        this.recipe = recipe;
    }
