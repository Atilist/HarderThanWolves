...
public class MysticalDevourerRecipeCategory implements RecipeCategory {
    ...
    public void drawExtras(Minecraft minecraft) {
        ItemRenderUtil.drawScaledItem(minecraft, new ItemStack(BlockListener.mysticalDevourer), 64, 28, 2);
    }
