...
public class ReinforcedSawRecipeCategory implements RecipeCategory {
    ...
    public void drawExtras(Minecraft minecraft) {
        ItemRenderUtil.drawScaledItem(minecraft, new ItemStack(net.atilist.harderthanwolves.events.init.BlockListener.reinforcedSaw), 64, 28, 2);
