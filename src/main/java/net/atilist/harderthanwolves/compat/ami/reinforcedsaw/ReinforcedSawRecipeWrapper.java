...
public class ReinforcedSawRecipeWrapper implements RecipeWrapper {
    private final ReinforcedSawRecipe recipe;

    public ReinforcedSawRecipeWrapper(ReinforcedSawRecipe recipe) {
        this.recipe = recipe;
    }
