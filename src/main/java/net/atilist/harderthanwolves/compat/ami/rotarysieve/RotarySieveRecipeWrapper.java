...
public class RotarySieveRecipeWrapper implements RecipeWrapper {
    private final RotarySieveRecipe recipe;

    public RotarySieveRecipeWrapper(RotarySieveRecipe recipe) {
        this.recipe = recipe;
    }
