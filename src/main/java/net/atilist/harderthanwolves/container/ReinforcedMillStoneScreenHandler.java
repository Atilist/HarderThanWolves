...
public class ReinforcedMillStoneScreenHandler extends ScreenHandler
{

    public ReinforcedMillStoneScreenHandler(Inventory playerinventory, ReinforcedMillStoneBlockEntity tileentityMillStone)
    {
    ...
    private ReinforcedMillStoneBlockEntity localTileEntityMillStone;
}
