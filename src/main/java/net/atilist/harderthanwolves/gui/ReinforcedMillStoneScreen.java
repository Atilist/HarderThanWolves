...
public class ReinforcedMillStoneScreen extends HandledScreen
{

    public ReinforcedMillStoneScreen(PlayerInventory inventoryplayer, ReinforcedMillStoneBlockEntity fctileentitymillstone, int locX, int locY, int locZ)
    {
        super(new ReinforcedMillStoneScreenHandler(inventoryplayer, fctileentitymillstone));
    ...
    {
        textRenderer.draw("Reinforced Mill Stone", 60, 6, 0x404040);
    ...
    private ReinforcedMillStoneBlockEntity associatedTileEntityMillStone;
    private int guiX;
    private int guiY;
    private int guiZ;
}
